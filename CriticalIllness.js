   ...
   useEffect(() => {
    const getData = async () => {
      const apiResponse = await fetch(
        "https://my-json-server.typicode.com/jeremychiaaaaa/Critical/options"
      );
...
export default function CriticalIllnessStack(){
    return(
        <Stack.Navigator>
            <Stack.Screen name='Critical Illness Stack' component={CriticalIllness} />
            <Stack.Screen name='Heart' component={Heart} />
            <Stack.Screen name='Lung' component={Lungs} />
