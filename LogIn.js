...
import { StyleSheet, Button, TextInput, Text, View, Alert, KeyboardAvoidingView,TouchableOpacity,Image,Dimensions,Platform } from 'react-native'
    ...
    const nav = useNavigation()
        return(
            ...
            <View style={{justifyContent:'center',marginTop:10}}>
                <Image source={{uri:'https://img.freepik.com/free-vector/turquoise-hospital-logo-template_1057-395.jpg?t=st=1651569324~exp=1651569924~hmac=9d948019719b4f32de418216dde4095ff430173a2ae999c8a7d0b8d46248d1b1&w=826'}} style={{width:'100%',height:height*0.3,marginTop:40,}} />
        ...
        >
            ...
            <Text style={{fontWeight:'100',opacity:1,color:'grey'}}>New to TRAVELMED ?</Text>
         <TouchableOpacity onPress={() => nav.navigate('Create Account')}>
